"""
refs:
https://github.com/akTwelve/Mask_RCNN/blob/master/samples/demo.ipynb
https://github.com/taisuke-ito/samples2/blob/master/demo_Analyze.ipynb
"""
import matplotlib
...
def detect():
    ...
    display_instances(image, r['rois'], r['masks'], r['class_ids'], class_names, r['scores'], ax=ax1)
    fig.tight_layout()
    plt.show(block=True)
